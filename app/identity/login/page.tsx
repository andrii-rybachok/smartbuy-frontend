   ...
   return (
      <div className={styles.loginPage}>
         ...
         <div className={styles.loginBlock + " "+helveticaRoman.className}>
            <div>
               <form action={() => LogIn({ cred: credentails })} className={styles.loginForm}>
                  <input
                     placeholder="Пошта"
                     type="text"
                     name="email"
                  ...
                  <input
                     ...
                     maxLength={20}
                  />
                  <input type="submit" className={styles.button} value="УВІЙТИ" />
                  <div>
            ...
            <div className={styles.links + " "+helveticaLight.className}>
               <span>Немає акаунту?</span>
               <Link href={"/identity/register"}>Зареєструватись</Link>
            </div>
         </div>
      </div>
   );
