...
export default function CategoriesColumn({ categories, activeCategoryId = "" }: CategoryColumnProps) {
      ...
      <div className={styles.categories + " " + helveticaRoman.className}>
         {categories.map((category, index) => {
            ...
            let categoryNameStyle =
               category.id == activeCategoryId ? styles.categoryActiveName : styles.categoryDefaultName;
